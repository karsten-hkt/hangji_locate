...
@Author : karsten
@File : hangji_model_resolution_matrix.py
@Software: PyCharm
============================
"""
# !/usr/bin/env python3
...
# 给定一个理论的地震位置
E_theritical = np.array([80.0, 30.0]).T
# 给定地震的时间
earthquake_time = 0.0
# 根据理论的位置到台站的位置去计算到时
...
for circle in range(stop_circle):
	...
	G, d, W, corr = locate_fun.build_matrices_with_lag_time(rel_coordinates, stp, lag_times_with_error, E0, v, sigma_t, maxlag, sample_rate)
